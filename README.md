...
| 8. DBStorage - Place | [models/place.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/place.py), [models/user.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/user.py), [models/city.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/city.py) | Update place.py, user.py and city.py |
| 9. DBStorage - Review | [models/review.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/review.py), [models/user.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/user.py), [models/place.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/place.py) | Updates review.py, user.py, place.py |
| 10. DBStorage - Amenity... and BOOM! | [models/amenity.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/amenity.py), [models/place.py](https://github.com/nasergamal/AirBnB_clone_v2/blob/master/models/place.py) | Updates amenity.py, place.py |
